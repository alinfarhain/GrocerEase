...
class _PlanPageState extends State<PlanPage> {
  ...
  Map<String, List<Meal>> _mealPlan = <String, List<Meal>>{};
  ...
  void _initializeMealPlan() {
    ...
    final List<Map<String, dynamic>> shuffledRecipes = List.from(_allRecipes)..shuffle();
  ...
  void _addMeal(DateTime date) {
    final dateKey = DateFormat('yyyy-MM-dd').format(date);
    final List<String> mealTypes = ['Breakfast', 'Lunch', 'High Tea', 'Dinner', 'Snack'];
    final randomRecipe = (_allRecipes..shuffle()).first;
    setState(() {
      ...
      _mealPlan[dateKey]!.add(
        Meal(
          ...
          mealType: mealTypes[_mealPlan[dateKey]!.length % mealTypes.length],
