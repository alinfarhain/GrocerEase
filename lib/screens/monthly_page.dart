...
class _MonthlyPageState extends State<MonthlyPage> {
  ...
  Future<void> _editMealAt({
    ...
    setState(() {
      ...
      _monthMealPlan.putIfAbsent(newDateKey, () => []).add(updatedMeal);
  ...
  void _showEditMealSheet(Meal meal, String dateKey, int index) {
    ...
    final customCatController = TextEditingController(text: meal.customCategoryName ?? '');
    bool isSaving = false;
                          ...
                          children: [
                            ...
                            GestureDetector(
                                ...
                                final picked = await showDatePicker(
                                  ...
                                  builder: (context, child) => Theme(
                                    data: Theme.of(context).copyWith(
                                      colorScheme: const ColorScheme.light(primary: Color(0xFF1BAB52)),
                                    ),
                                    child: child!,
                                  ),
                                );
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    const Icon(Icons.calendar_month_outlined, color: Color(0xFF1BAB52)),
                                    const SizedBox(width: 12),
                                    Expanded(
                                      child: Text(
                                        DateFormat('d/M/yyyy — EEEE').format(selectedDate),
                            ...
                            Wrap(
                              ...
                              children: ['Breakfast', 'Lunch', 'Dinner', 'High Tea', 'Custom']
                                  .map((cat) {
                                ...
                                return GestureDetector(
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        color: isSelected ? const Color(0xFF1BAB52) : Colors.grey[300]!,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        if (isSelected) ...[
                                          const Icon(Icons.check, size: 14, color: Color(0xFF1BAB52)),
                                          const SizedBox(width: 4),
                                        ],
                                        Text(cat,
                                            style: TextStyle(
                                              color: isSelected ? const Color(0xFF1BAB52) : Colors.black87,
            ...
            child: Column(
              children: [
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: const TextStyle(
                          fontSize: 18.0, fontWeight: FontWeight.bold, color: Color(0xFF003D33)),
                    ),
                    IconButton(
                ...
                _isLoadingMonth
                    ? const SizedBox(
                    height: 200,
                    child: Center(child: CircularProgressIndicator(color: Color(0xFF1BAB52), strokeWidth: 2)))
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Row(children: [
            Container(width: 12.0, height: 4.0,
                decoration: BoxDecoration(color: const Color(0xFF1BAB52), borderRadius: BorderRadius.circular(2.0))),
            const SizedBox(width: 8.0),
  ...
  Widget _buildSelectedDayMeals() {
    ...
    return Column(
      ...
      children: [
        Text(formattedDate,
            style: const TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold, color: Color(0xFF003D33))),
        ...
        if (meals.isEmpty)
          Container(
            ...
            child: const Center(
              child: Column(children: [
                ...
                SizedBox(height: 8),
                Text('No meals planned', style: TextStyle(fontSize: 16.0, color: Colors.grey)),
              ]),
            ),
          )
        else
          ...meals.asMap().entries.map((entry) {
            ...
            return Dismissible(
              ...
              direction: widget.isEditing ? DismissDirection.endToStart : DismissDirection.none,
              ...
              onDismissed: (_) => _deleteMealAt(dateKey, idx),
              child: Container(
                margin: const EdgeInsets.only(bottom: 12.0),
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(meal.categoryLabel,
                          style: const TextStyle(fontSize: 12.0, fontWeight: FontWeight.w600, color: Color(0xFF1BAB52))),
                    ),
                    const SizedBox(width: 12.0),
                    Expanded(
                      child: GestureDetector(
                        onTap: () {
                          if (!widget.isEditing && meal.originalData != null) {
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(meal.title,
                                style: const TextStyle(fontSize: 15.0, fontWeight: FontWeight.w600, color: Color(0xFF003D33)),
                    ...
                    if (widget.isEditing) ...[
                      const SizedBox(width: 8.0),
                      GestureDetector(
                        onTap: () => _showEditMealSheet(meal, dateKey, idx),
                        child: Container(
